...
public class ArabicToRomanNumeralsTests extends JUnitStories {
		 
	private Configuration configuration;
	
		public ArabicToRomanNumeralsTests() {
			super();
		...
		public InjectableStepsFactory stepsFactory() {
			return new InstanceStepsFactory(configuration, new ConversionSteps());
		}
